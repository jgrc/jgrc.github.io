...
function EntidadAlien(){
	...
	*/
	this.constructor=function(juego,xIni,yIni,fila){
		...
		{
			case 0:
				this.constructorBase(40,25,[Sprites.get("img/alien1a.jpg"),Sprites.get("img/alien1b.jpg")],200,xIni,yIni,"a");
				break;
			case 1:
			case 2:
				this.constructorBase(40,25,[Sprites.get("img/alien2a.jpg"),Sprites.get("img/alien2b.jpg")],250,xIni,yIni,"a");
				break;
			default:
				this.constructorBase(40,25,[Sprites.get("img/alien3a.jpg"),Sprites.get("img/alien3b.jpg")],300,xIni,yIni,"a");
				break;
		}
		this.juego=juego;
	...
	*/
	this.destruir=function(){
		this.sprites=[Sprites.get("img/explosion.jpg")];
		this.spriteActual=0;
		this.destruido=50;
	};
	/**
